...
public class TLanguagesId implements java.io.Serializable {
	...
	/** full constructor */
	public TLanguagesId(String key, String languageKey) {
		this.key = key;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TLanguagesId))
			return false;
		TLanguagesId castOther = (TLanguagesId) other;
