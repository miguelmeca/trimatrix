...
/**
 * AbstractTCountriesId entity provides the base persistence definition of the
 * TCountriesId entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractTCountriesId implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTCountriesId() {
	}

	/** full constructor */
	public AbstractTCountriesId(String key, String languageKey) {
		this.key = key;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AbstractTCountriesId))
			return false;
		AbstractTCountriesId castOther = (AbstractTCountriesId) other;
