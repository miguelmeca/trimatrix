 ...
 */
@Embeddable
public class TSalutationId implements java.io.Serializable {
	...
	/** default constructor */
	public TSalutationId() {
	}

	/** full constructor */
	public TSalutationId(String key, String languageKey) {
		this.key = key;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSalutationId))
			return false;
		TSalutationId castOther = (TSalutationId) other;
