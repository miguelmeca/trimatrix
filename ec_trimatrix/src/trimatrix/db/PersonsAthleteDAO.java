 ...
 * PersonsAthlete entities. Transaction control of the save(), update() and
...
public class PersonsAthleteDAO extends HibernateDaoSupport implements ISimpleDAO<PersonsAthlete>{
	...
	public List<PersonsAthlete> findByExample(PersonsAthlete instance) {
		log.debug("finding PersonsAthlete instance by example");
		try {
			List<PersonsAthlete> results = getHibernateTemplate().findByExample(instance);
	...
	@SuppressWarnings("unchecked")
	public List<PersonsAthlete> findByProperty(String propertyName, Object value) {
		log.debug("finding PersonsAthlete instance with property: "
	...
	@SuppressWarnings("unchecked")
	public List<PersonsAthlete> findAll() {
	...
	@SuppressWarnings("unchecked")
	public static ISimpleDAO<PersonsAthlete> getFromApplicationContext(
			ApplicationContext ctx) {
		return (ISimpleDAO<PersonsAthlete>) ctx.getBean("PersonsAthleteDAO");
	}
}