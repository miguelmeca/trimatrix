...
/**
 * AbstractTCurrenciesId entity provides the base persistence definition of the
 * TCurrenciesId entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractTCurrenciesId implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTCurrenciesId() {
	}

	/** full constructor */
	public AbstractTCurrenciesId(String key, String languageKey) {
		this.key = key;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AbstractTCurrenciesId))
			return false;
		AbstractTCurrenciesId castOther = (AbstractTCurrenciesId) other;
