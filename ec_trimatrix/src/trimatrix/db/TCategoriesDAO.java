...
public class TCategoriesDAO extends HibernateDaoSupport implements ITCategoriesDAO {
    ...
    public List findByExample(TCategories instance) {
	...
	public static TCategoriesDAO getFromApplicationContext(ApplicationContext ctx) {
    	return (TCategoriesDAO) ctx.getBean("TCategoriesDAO");
	}
}