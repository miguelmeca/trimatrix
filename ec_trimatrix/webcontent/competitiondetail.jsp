...
<t:calendarfield id="g_14" attributemacro="entityDetailMacro(CompetitionDetailUI,date)" timezone="CET" width="200" />
</t:row>
<t:row id="g_15" >
<t:label id="g_16" rowalignmenty="top" text="#{rr.literals.address}" width="100" />
<t:textarea id="g_17" attributemacro="entityDetailMacro(CompetitionDetailUI,address)" height="55" width="300" />
</t:row>
<t:row id="g_18" >
<t:label id="g_19" text="#{rr.literals.country}" width="100" />
<t:combobox id="g_20" attributemacro="entityDetailMacro(CompetitionDetailUI,country)" validvaluesbinding="#{helper.vvb.country}" width="200" />
</t:row>
<t:rowdistance id="g_21" />
<t:row id="g_22" comment="Limits" rendered="#{d.CompetitionDetailUI.myCompetition}" >
<t:pane id="g_23" height="100%" rowdistance="5" width="100%" >
<t:row id="g_24" >
<t:label id="g_25" font="size:12;weight:bold" text="#{rr.literals.limits}" />
</t:row>
<t:row id="g_26" >
<t:fixgrid id="g_27" avoidroundtrips="true" horizontalscrollmode="autowithresize" objectbinding="#{d.CompetitionDetailUI.gridLimits}" sbvisibleamount="10" selectorcolumn="1" selectorcolumnwidth="20" showemptyrows="false" >
