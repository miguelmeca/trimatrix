...
<fieldset>
	<legend class="collapsible" id="serverInfo"><format:message key="serverInfo.legend"/></legend>
<table id="serverInfo-target" style="text-align: left;" border="0">
	<tr>
		...
		<td title='<format:message key="serverInfo.workingDir">
			...
			</format:message>'><%= getServletConfig().getServletContext().getServerInfo() %></td>
...
<fieldset>
	<legend class="collapsible" id="cpu-memory"><format:message key="cpuMem.legend"/></legend>
...
<fieldset>
	<legend class="collapsible" id="vmInfo"><format:message key="vmInfo.legend"/></legend>
...
<%	DisplayDataHolder serverSpecificData = (DisplayDataHolder) pageContext.getAttribute("serverSpecificData");
    ++index; %>
	<fieldset>
		<legend class="collapsible" id="extraServerAttributes-<%=index%>"><%= serverSpecificData.getTitle() %></legend>
		<div id="extraServerAttributes-<%=index%>-target"><div id="<%=serverSpecificData.getHTMLId()%>"><%= serverSpecificData.getXHTMLData() %></div></div>
	</fieldset>
</core:forEach>
</div>
