...
<t:button id="g_11" actionListener="#{eclntdefscr.popupIdTextSelection.onCancel}" contentareafilled="false" text="#{eclnti18n.IDTEXTSEL_cancel}" />
  ...
  <t:row id="g_1112" >
    <t:scrollpane id="g_1113" border="#C0C0C0" height="100" width="100%" >
      <t:row id="g_1114" >
        <t:textpane id="g_1115" height="100%" text="#{eclntdefscr.popupIdTextSelection.explanation}" width="100%" stylevariant="IDVALUESELECTION"/>
      </t:row>
    </t:scrollpane>
  </t:row>
</t:pane>
