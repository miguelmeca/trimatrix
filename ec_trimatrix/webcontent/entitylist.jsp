...
<t:row id="g_10" rendered="#{d.EntityListUI.renderButtons}" >
...
<t:row id="g_18" rendered="#{d.EntityListUI.renderButtons}" >
<t:button id="g_19" actionListener="#{d.EntityListUI.onRefresh}" image="/images/icons/refresh.png" imageheight="15" text="#{rr.literals.list_refresh}" />
<t:coldistance id="g_20" width="100%" />
<t:button id="g_21" actionListener="#{d.EntityListUI.gridList.onEditColumnDetails}" image="/images/icons/configure.png" imageheight="15" text="#{rr.literals.list_configure}" />
<t:button id="g_22" actionListener="#{d.EntityListUI.saveGridState}" image="/images/icons/save.png" imageheight="15" text="#{rr.literals.save}" />
</t:row>
</t:pane>
</t:row>
</t:rowbodypane>
