...
<t:row id="g_4" >
<t:fixgrid id="g_5" avoidroundtrips="1" objectbinding="#{d.ZonesDetailUI.gridZones}" sbvisibleamount="25" width="100%" >
<t:gridcol id="g_6" align="center" searchenabled="false" sortenabled="false" text="Farbe" width="100" >
<t:colorfield id="g_7" background=".{color}" flush="true" value=".{color}" />
</t:gridcol>
<t:gridcol id="g_8" align="center" searchenabled="false" sortenabled="false" text="Kürzel" width="100" >
<t:field id="g_9" background=".{color}" text=".{token}" width="100" />
</t:gridcol>
...
<t:row id="g_16" >
<t:button id="g_17" actionListener="#{d.ZonesDetailUI.onAddZone}" text="Neue Zone" />
</t:row>
</t:rowbodypane>
