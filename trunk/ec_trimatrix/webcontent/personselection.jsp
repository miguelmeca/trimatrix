...
<t:gridcol id="g_3" align="center" searchenabled="true" sortreference=".{entity.salutation}" text="#{rr.literals.person_salutation}" width="50" >
<t:label id="g_4" text=".{entity.salutation}" />
</t:gridcol>
<t:gridcol id="g_5" align="center" searchenabled="true" sortreference=".{entity.name_first}" text="#{rr.literals.person_first_name}" width="100" >
