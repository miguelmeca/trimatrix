...
<t:row id="g_12" >
<t:button id="g_13" actionListener="#{d.ScheduleUI.onCreateTemplate}" image="/images/icons/template.png" imageheight="16" text="#{rr.literals.create_template}" />
</t:row>
<t:rowdistance id="g_14" height="10" />
<t:row id="g_15" />
<t:rowdistance id="g_16" height="10" />
<t:row id="g_17" >
<t:foldablepopupinclude id="g_18" height="100%" page="../scheduletemplates.jsp" popupwidth="200" text="#{rr.literals.templates}" width="100%" />
</t:row>
<t:rowdistance id="g_19" />
<t:row id="g_20" >
<t:foldablepane id="g_21" padding="0" text="#{rr.literals.summary}" width="100%" >
<t:rowdynamiccontent id="g_22" />
<t:row id="g_23" >
<t:field id="g_24" width="135" />
</t:row>
</t:foldablepane>
</t:row>
</t:pane>
...
<t:combobox id="g_125" actionListener="#{d.ScheduleUI.onChangeAthlete}" validvaluesbinding="#{helper.vvb.myathletesandme}" value="#{d.ScheduleUI.searchAthleteId}" width="200" withnullitem="true" />
</t:row>
<t:row id="g_126" >
...
<t:menuitem id="g_152" command="cmdAdd" text="Neu" />
</t:popupmenu>
<t:popupmenu id="SCHEDULEITEM" >
<t:menuitem id="g_153" command="cmdEdit" image="/images/icons/edit.png" text="#{rr.literals.change}" />
<t:menuitem id="g_154" command="cmdRemove" image="/images/icons/delete.png" text="#{rr.literals.delete}" />
<t:menuitem id="g_155" command="cmdCopy" image="/images/icons/copy.png" text="#{rr.literals.copy}" />
</t:popupmenu>
