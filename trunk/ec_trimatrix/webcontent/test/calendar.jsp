...
<t:row id="g_75" >
<t:schedule id="g_76" background="null!" bgpaint="rectangle(0,0,100%,100%,#80808060,#80808000,horizontal)" border="#C0C0C0" height="100%" numberofblocks="12" orientation="vertical" schedulemax="24" width="60" >
<t:scheduleitem id="g_77" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="0" schedulewidth="1" text="06:00" />
<t:scheduleitem id="g_78" scheduleleft="1" schedulewidth="1" />
<t:scheduleitem id="g_79" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="2" schedulewidth="1" text="07:00" />
<t:scheduleitem id="g_80" scheduleleft="3" schedulewidth="1" />
<t:scheduleitem id="g_81" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="4" schedulewidth="1" text="08:00" />
<t:scheduleitem id="g_82" scheduleleft="5" schedulewidth="1" />
<t:scheduleitem id="g_83" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="6" schedulewidth="1" text="09:00" />
<t:scheduleitem id="g_84" scheduleleft="7" schedulewidth="1" />
<t:scheduleitem id="g_85" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="8" schedulewidth="1" text="10:00" />
<t:scheduleitem id="g_86" scheduleleft="9" schedulewidth="1" />
<t:scheduleitem id="g_87" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="10" schedulewidth="1" text="11:00" />
<t:scheduleitem id="g_88" scheduleleft="11" schedulewidth="1" />
<t:scheduleitem id="g_89" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="12" schedulewidth="1" text="12:00" />
<t:scheduleitem id="g_90" scheduleleft="13" schedulewidth="1" />
<t:scheduleitem id="g_91" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="14" schedulewidth="1" text="13:00" />
<t:scheduleitem id="g_92" scheduleleft="15" schedulewidth="1" />
<t:scheduleitem id="g_93" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="16" schedulewidth="1" text="14:00" />
<t:scheduleitem id="g_94" scheduleleft="17" schedulewidth="1" />
<t:scheduleitem id="g_95" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="18" schedulewidth="1" text="15:00" />
<t:scheduleitem id="g_96" scheduleleft="19" schedulewidth="1" />
<t:scheduleitem id="g_97" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="20" schedulewidth="1" text="16:00" />
<t:scheduleitem id="g_98" scheduleleft="21" schedulewidth="1" />
<t:scheduleitem id="g_99" align="right!" font="size:12;weight:bold" resizingenabled="false" scheduleleft="22" schedulewidth="1" text="17:00" />
<t:scheduleitem id="g_100" scheduleleft="23" schedulewidth="1" />
</t:schedule>
<t:schedule id="g_101" attributemacro="scheduleMacro(0)" width="16%" />
<t:schedule id="g_102" attributemacro="scheduleMacro(1)" width="16%" />
<t:schedule id="g_103" attributemacro="scheduleMacro(2)" width="16%" />
<t:schedule id="g_104" attributemacro="scheduleMacro(3)" width="16%" />
<t:schedule id="g_105" attributemacro="scheduleMacro(4)" width="16%" />
<t:schedule id="g_106" attributemacro="scheduleMacro(5)" width="10%" />
<t:schedule id="g_107" attributemacro="scheduleMacro(6)" width="10%" />
</t:row>
</t:pane>
</t:row>
</t:pane>
...
<t:tabbedpanetab id="g_108" bgpaint="!null" text="Agenda" >
<t:row id="g_109" >
<t:fixgrid id="g_110" avoidroundtrips="true" background="#FFFFFF" drawoddevenrows="true" horizontalscrollmode="autowithresize" noscrollmode="true" objectbinding="#{d.ScheduleUI.gridAgenda}" sbvisibleamount="30" showemptyrows="false" width="100%" >
<t:gridcol id="g_111" columnresizingenabled="false" width="20" >
<t:gridrowselector id="g_112" background=".{scheduleItem.color}" />
</t:gridcol>
<t:gridcol id="g_113" align="center" searchenabled="true" sortenabled="true" text="Start" width="150" >
<t:formattedfield id="g_114" align="center" enabled="false" exacttime="true" focusable="false" format="datetime" formatmask="medium" value=".{scheduleItem.from}" />
</t:gridcol>
<t:gridcol id="g_115" align="center" searchenabled="true" sortenabled="true" text="Ende" width="150" >
<t:formattedfield id="g_116" align="center" enabled="false" exacttime="true" focusable="false" format="datetime" formatmask="medium" value=".{scheduleItem.to}" />
</t:gridcol>
<t:gridcol id="g_117" align="center" searchenabled="true" sortenabled="true" text="Type" width="100" >
<t:label id="g_118" text=".{scheduleItem.type}" />
</t:gridcol>
<t:gridcol id="g_119" align="center" searchenabled="true" sortenabled="true" text="Beschreibung" width="200" >
<t:label id="g_120" text=".{scheduleItem.text}" />
</t:gridcol>
</t:fixgrid>
</t:row>
</t:tabbedpanetab>
...
<t:menuitem id="g_121" command="cmdAdd" text="Neu" />
</t:popupmenu>
<t:popupmenu id="SCHEDULEITEM" >
<t:menuitem id="g_122" command="cmdEdit" text="Ändern" />
<t:menuitem id="g_123" command="cmdRemove" text="Löschen" />
</t:popupmenu>
