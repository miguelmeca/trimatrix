...
<t:heximage id="g_5" border="#808080" height="130" hexdata="#{d.PersonDetailUI.picture}" width="130" x="365" y="30" />
...
<t:fileuploadbutton id="g_12" actionListener="#{d.PersonDetailUI.onUploadImage}" enabled="#{d.PersonDetailUI.enabled}" fileextensions="jpg;png;gif" height="20" rendered="#{d.PersonDetailUI.enabled}" text="#{rr.literals.edit}" width="60" x="370" y="170" />
