...
<%	DisplayDataHolder sessionSpecificData = (DisplayDataHolder) pageContext.getAttribute("sessionSpecificData");
    ++index; %>
	<fieldset>
		<legend class="collapsible" id="extraSessionAttributes-<%=index%>"><%= sessionSpecificData.getTitle() %></legend>
		<div id="extraSessionAttributes-<%=index%>-target"><div id="<%=sessionSpecificData.getHTMLId()%>"><%= sessionSpecificData.getXHTMLData() %></div></div>
	</fieldset>
</core:forEach>
</div>
