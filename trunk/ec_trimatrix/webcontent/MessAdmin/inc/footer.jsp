...
<br />
<a href="http://messadmin.sourceforge.net" target="_new">MessAdmin</a> <core:out value="<%= MessAdmin.getVersion() %>"/> &copy; 2005&ndash;2009 C&eacute;drik LIME, <format:message key="copyright.rights"/>
</div>
