...
<t:row id="g_11" >
<t:fixgrid id="g_12" avoidroundtrips="true" cellselection="true" headlinerowheight="20" horizontalscrollmode="autowithresize" objectbinding="#{d.ZonesDefinitionUI.gridZones}" rowheight="20" sbvisibleamount="10" showemptyrows="false" >
...
<t:colorfield id="g_16" background=".{zonesDefinition.color}" enabled="#{d.ZonesDefinitionUI.changeAllowed}" flush="true" focusable="false" foreground=".{zonesDefinition.color}" value=".{zonesDefinition.color}" />
</t:gridcol>
