...
<t:gridcol id="g_3" searchenabled="true" sortreference=".{entity.user_name}" text="Benutzer" width="100" >
<t:label id="g_4" text=".{entity.user_name}" />
</t:gridcol>
</t:fixgrid>
</t:row>
<t:row id="g_5" >
<t:button id="g_6" actionListener="#{d.UserSelectionUI.onSelect}" text="#{rr.literals.select}" />
<t:coldistance id="g_7" width="100%" />
<t:button id="g_8" actionListener="#{d.UserSelectionUI.onCancel}" text="#{rr.literals.cancel}" />
</t:row>
