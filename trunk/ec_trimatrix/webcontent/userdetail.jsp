...
<t:button id="g_9" actionListener="#{d.UserDetailUI.onPersonSearch}" enabled="#{d.UserDetailUI.enabled}" height="20" text="#{rr.literals.edit}" width="60" x="225" y="90" />
<t:button id="g_10" actionListener="#{d.UserDetailUI.onPersonRemove}" enabled="#{d.UserDetailUI.enabled}" height="20" text="#{rr.literals.delete}" width="60" x="290" y="90" />
<t:label id="g_11" height="20" text="#{rr.literals.user_email}" width="85" x="20" y="120" />
<t:field id="g_12" attributemacro="entityDetailMacro(UserDetailUI,email)" width="100" x="115" y="120" />
</t:paintarea>
</t:row>
