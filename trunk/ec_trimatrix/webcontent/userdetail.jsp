...
<t:field id="g_4" attributemacro="entityDetailMacro(UserDetailUI,user_name)" width="200" x="115" y="30" />
...
<t:row id="g_7" >
<t:label id="g_8" height="20" text="#{rr.literals.language}" width="85" x="20" y="60" />
...
<t:row id="g_10" >
<t:label id="g_11" height="20" text="#{rr.literals.user_person}" width="85" x="20" y="90" />
...
<t:row id="g_17" >
<t:label id="g_18" height="20" text="#{rr.literals.user_email}" width="85" x="20" y="120" />
<t:field id="g_19" attributemacro="entityDetailMacro(UserDetailUI,email)" width="200" x="115" y="120" />
</t:row>
<t:row id="g_20" >
<t:label id="g_21" height="20" text="#{rr.literals.user_active}" width="85" x="20" y="150" />
<t:checkbox id="g_22" align="center" enabled="false" height="20" selected="#{d.UserDetailUI.values.active}" x="115" y="150" />
</t:row>
<t:row id="g_23" >
<t:label id="g_24" height="20" text="#{rr.literals.user_locked}" width="85" x="20" y="180" />
