...
insert  into `tests`(`id`,`person_id`,`doctor_id`,`coach_id`,`type`,`date`,`description`,`created_at`,`created_by`,`modified_at`,`modified_by`,`deleted`,`test`) values ('aa109083-8cfb-11de-a422-4e7d893777af','10f52302-2ddb-11de-86ae-00301bb60f17','d0782a5c-495d-11de-921e-1178275b5596','0b0b7658-2ddb-11de-86ae-00301bb60f17','treadmill','2009-08-19 00:00:00','Das ist mein erster Test','1900-01-01 00:00:00','e96bcbd2-676d-102c-ace2-9cc3fca64c87','2009-08-20 23:28:00','e96bcbd2-676d-102c-ace2-9cc3fca64c87',0,0);
...
CREATE TABLE `tests_swim` (
  ...
  `distance` int(11) DEFAULT NULL COMMENT 'Datensatz erstellt von',
  `splits` int(11) DEFAULT NULL COMMENT 'Datensatz erstellt am',
  PRIMARY KEY (`id`),
