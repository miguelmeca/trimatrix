...
public class TAuthorizationsId implements java.io.Serializable {
	...
	/** default constructor */
	public TAuthorizationsId() {
	}

	/** full constructor */
	public TAuthorizationsId(String key, String languageKey) {
		this.key = key;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TAuthorizationsId))
			return false;
		TAuthorizationsId castOther = (TAuthorizationsId) other;
