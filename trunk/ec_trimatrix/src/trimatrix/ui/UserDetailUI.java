...
public class UserDetailUI extends AEntityDetailUI implements Serializable
{
	...
	public void onPersonSearch(ActionEvent event) {
    	...
    	m_popup.open(Constants.Page.PERSONSELECTION.getUrl(), Helper.getLiteral("person_search"), 800, 600, this);
    }
	...
	public void onSendGeneratedPassword(ActionEvent event) {
		YESNOPopup popup = YESNOPopup.createInstance(
				Helper.getMessages("generate_password"),
				Helper.getMessages("confirm_generate_password"),
				new IYesNoCancelListener(){
					...
					public void reactOnYes() {
						...
						try {
							...
							Statusbar.outputAlert(Helper.getMessages("password_send_failure"), Helper.getLiteral("error"), ex.toString()).setLeftTopReferenceCentered();
						}
					}
				}
		);
